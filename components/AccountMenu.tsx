          ...
          <>
            <div className="flex flex-col gap-3">
              <div className="px-3 group/item flex flex-row gap-3 items-center w-full">
                ...
                <p
                  key={item?.id}
                  onClick={() => routeHome(item?.name)}
                  className={
                    item?.name === childUsername
                      ? "text-white font-bold text-sm group-hover/item:underline"
                      : "text-gray-500 text-sm group-hover/item:underline"
                  }
                >
                  {item?.name}
                </p>
